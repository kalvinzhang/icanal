...
const file_proto_canal_protocol_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/canal_protocol.proto\x12 com.alibaba.otter.canal.protocol\"\xb4\x02\n" +
	"\x06Packet\x12#\n" +
	"\fmagic_number\x18\x01 \x01(\x05H\x00R\vmagicNumber\x12\x1a\n" +
	"\aversion\x18\x02 \x01(\x05H\x01R\aversion\x12@\n" +
	"\x04type\x18\x03 \x01(\x0e2,.com.alibaba.otter.canal.protocol.PacketTypeR\x04type\x12Q\n" +
	"\vcompression\x18\x04 \x01(\x0e2-.com.alibaba.otter.canal.protocol.CompressionH\x02R\vcompression\x12\x12\n" +
	...
	"\x0fstart_timestamp\x18\x02 \x01(\x03R\x0estartTimestamp\"\xe2\x01\n" +
	"\tHandshake\x127\n" +
	"\x16communication_encoding\x18\x01 \x01(\tH\x00R\x15communicationEncoding\x12\x14\n" +
	"\x05seeds\x18\x02 \x01(\fR\x05seeds\x12d\n" +
	"\x16supported_compressions\x18\x03 \x01(\x0e2-.com.alibaba.otter.canal.protocol.CompressionR\x15supportedCompressionsB \n" +
	...
	"\x0eCLIENTROLLBACK\x10\fBF\n" +
	" com.alibaba.otter.canal.protocolB\vCanalPacketH\x01Z\x13./protocol;protocolb\x06proto3"
